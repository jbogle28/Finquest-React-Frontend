...
const styles = {
    ...
    glow: {
        ...
        zIndex: -1, borderRadius: '24px'
    },
    mascotContainer: { position: 'relative', marginBottom: '8px', display: 'inline-block' },
